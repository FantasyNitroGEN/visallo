...
public class LocalDateSingleValueVisalloPropertyTest {
    private static final TimeZone UTC_TIME_ZONE = TimeZone.getTimeZone("UTC");

    private LocalDateSingleValueVisalloProperty localDateProperty = new LocalDateSingleValueVisalloProperty("name");

    @Test
    public void wrapReturnsLegacyDateAtMidnightUTCForLocalDate() throws Exception {
        LocalDate localDate = LocalDate.now();

        Date legacyDateTime = localDateProperty.wrap(localDate);
    ...
    public void unwrapReturnsLocalDateForLegacyDate() throws Exception {
        ...
        LocalDate localDate = localDateProperty.unwrap(legacyDateTime);
