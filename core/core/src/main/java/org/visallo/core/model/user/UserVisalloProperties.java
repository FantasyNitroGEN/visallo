...
public final class UserVisalloProperties {
    ...
    public static final StringSingleValueVisalloProperty AUTHORIZATIONS = new StringSingleValueVisalloProperty("http://visallo.org/user#authorizations");
    public static final StringSingleValueVisalloProperty PRIVILEGES = new StringSingleValueVisalloProperty("http://visallo.org/user#privileges");
