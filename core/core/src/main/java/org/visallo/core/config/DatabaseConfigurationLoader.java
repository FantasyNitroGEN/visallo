...
public class DatabaseConfigurationLoader extends ConfigurationLoader {
     ...
     */
    public static final String ENV_BOOTSTRAP_LOCATION = "VISALLO_BOOTSTRAP_LOCATION";
    public static final String DEFAULT_BOOTSTRAP_LOCATION = "/opt/visallo/config";
    ...
    public File resolveFileName(String fileName) {
        ...
        if (files.containsKey(fileName)) {
            try {
                ...
                throw new VisalloException("error creating temporary file for file: " + fileName, ioe);
            }
        }
    ...
    private Map<String, String> getBootstrapProperties() {
        ...
        for (File file : bootstrapPropertiesFiles) {
            try {
                ...
                throw new VisalloException("error loading bootstrap properties from file: " + file.getName(), ioe);
            }
        }
    ...
    private Map<String, String> selectDatabaseValues() {
        ...
        try {
            ...
            throw new VisalloException("error selecting values from the database", se);
        } catch (ClassNotFoundException cnfe) {
            ClassUtil.logClasspath(this.getClass().getClassLoader(), System.err);
            throw new VisalloException("error loading database driver class: " + config.databaseDriverClass, cnfe);
        }
        return map;
    }
