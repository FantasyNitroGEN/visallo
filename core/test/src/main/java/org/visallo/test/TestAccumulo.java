...
public class TestAccumulo {
    ...
    private final Properties visalloConfig;
    ...
    private void setVisalloProperties() {
        visalloConfig.setProperty("simpleOrm.accumulo.instanceName", accumulo.getInstanceName());
        visalloConfig.setProperty("simpleOrm.accumulo.zookeeperServerNames", accumulo.getZooKeepers());
        visalloConfig.setProperty("graph.zookeeperServers", accumulo.getZooKeepers());
    }
}
