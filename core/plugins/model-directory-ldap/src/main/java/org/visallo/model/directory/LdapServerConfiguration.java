...
public class LdapServerConfiguration {
    ...
    private LdapServerConnectionType connectionType;
    ...
    @Configurable(name = "connectionType", defaultValue = "LDAPS")
    public void setConnectionType(String connectionType) {
        this.connectionType = LdapServerConnectionType.valueOf(connectionType);
    }
    ...
    public LdapServerConnectionType getConnectionType() {
