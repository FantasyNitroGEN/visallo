...
public class HdfsLimitOutputStreamTest {
    ...
    public void testSmall() throws NoSuchAlgorithmException, IOException {
        ...
        assertEquals("urn" + RowKeyHelper.FIELD_SEPARATOR + "sha256" + RowKeyHelper.FIELD_SEPARATOR + "1f825aa2f0020ef7cf91dfa30da4668d791c5d4824fc8e41354b89ec05795ab3", out.getRowKey());
    }
    ...
    public void testLarge() throws NoSuchAlgorithmException, IOException {
        ...
        assertEquals("urn" + RowKeyHelper.FIELD_SEPARATOR + "sha256" + RowKeyHelper.FIELD_SEPARATOR+ "78a6273103d17c39a0b6126e226cec70e33337f4bc6a38067401b54a33e78ead", out.getRowKey());
