package org.visallo.sql.model.longRunningProcess;
...
public class SqlLongRunningProcessRepository extends LongRunningProcessRepository {
    private static final VisalloLogger LOGGER = VisalloLoggerFactory.getLogger(SqlLongRunningProcessRepository.class);
    ...
    public String enqueue(JSONObject longRunningProcessQueueItem, User user, Authorizations authorizations) {
        ...
        try {
            ...
            throw new VisalloException("Could not add long running process: " + longRunningProcessQueueItem.toString(), e);
        }
    ...
    private SqlLongRunningProcess findSqlLongRunningProcessById(String longRunningProcessId) {
        ...
        if (longRunningProcesses.size() == 0) {
            ...
            throw new VisalloException("more than one long running process was returned");
        } else {
    ...
    public void updateLongRunningProcess(String longRunningProcessId, UpdateLongRunningProcessAction updateLongRunningProcessAction) {
        ...
        try {
            ...
            throw new VisalloException("Could not update long running process: " + longRunningProcess.toString(), e);
        }
    }
