...
wget -O /opt/hadoop-2.6.0.tar.gz https://archive.apache.org/dist/hadoop/core/hadoop-2.6.0/hadoop-2.6.0.tar.gz
tar -xzf /opt/hadoop-2.6.0.tar.gz -C /opt/
rm /opt/hadoop-2.6.0.tar.gz
...
rm -rf /opt/hadoop-2.6.0/logs
ln -s /var/log/hadoop /opt/hadoop-2.6.0/logs
