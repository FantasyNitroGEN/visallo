...
public class VertexIntegrationTest extends VertextTestBase {
    ...
    private VisalloApi authenticateApiUser(String... userAuths) throws ApiException {
        String setupWorkspaceId = setupVisalloApi.getCurrentWorkspaceId(); // capture before switching users
