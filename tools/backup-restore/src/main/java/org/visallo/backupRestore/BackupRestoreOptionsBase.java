...
public abstract class BackupRestoreOptionsBase {
    ...
    public String getVertexiumHdfsOverflowDirectory() {
        return vertexiumHdfsOverflowDirectory;
    }

    public BackupRestoreOptionsBase setVertexiumHdfsOverflowDirectory(String vertexiumHdfsOverflowDirectory) {
        this.vertexiumHdfsOverflowDirectory = vertexiumHdfsOverflowDirectory;
        return this;
    }
