...
public class BackupRestore {
    ...
    private static final String DEFAULT_TABLE_NAME_PREFIX = "visallo_";
    ...
    private static final String CMD_OPT_VERTEXIUM_HDFS_OVERFLOW_DIRECTORY = "vertexiumHdfsOverflowDirectory";
    private static final String DEFAULT_VERTEXIUM_HDFS_OVERFLOW_DIRECTORY = "/visallo/vertexium";
    ...
    private String vertexiumHdfsOverflowDirectory;
    ...
    private void run(String[] args) {
        ...
        vertexiumHdfsOverflowDirectory = cmd.getOptionValue(CMD_OPT_VERTEXIUM_HDFS_OVERFLOW_DIRECTORY, DEFAULT_VERTEXIUM_HDFS_OVERFLOW_DIRECTORY);
    ...
    private void setCommonOptions(BackupRestoreOptionsBase options) {
        options
                ...
                .setVertexiumHdfsOverflowDirectory(vertexiumHdfsOverflowDirectory)
