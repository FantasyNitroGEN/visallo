package org.visallo.dbpedia.mapreduce.model;
...
public class LineData {
    ...
    public static LineData parse(String line) {
        ...
        if (!m.matches()) {
            throw new VisalloException("Could not find match for line: " + line);
        }
    ...
    public static String parsePageTitleFromPageUrl(String pageUrl) {
        ...
        if (lastSlash < 0) {
            throw new VisalloException("Could not parse page title from page url: " + pageUrl);
        }
