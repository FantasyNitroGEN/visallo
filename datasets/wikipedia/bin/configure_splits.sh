...
_configure_splits visallo_vertexium_d DVWIKIPEDIA_
_configure_splits visallo_vertexium_e EWIKIPEDIA_LINK_
_configure_splits visallo_vertexium_v VWIKIPEDIA_
