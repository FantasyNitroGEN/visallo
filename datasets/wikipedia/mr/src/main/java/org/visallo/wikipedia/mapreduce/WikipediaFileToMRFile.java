...
import org.visallo.wikipedia.RandomAccessFileInputStream;
...
public class WikipediaFileToMRFile {
    private static final VisalloLogger LOGGER = VisalloLoggerFactory.getLogger(WikipediaFileToMRFile.class);
