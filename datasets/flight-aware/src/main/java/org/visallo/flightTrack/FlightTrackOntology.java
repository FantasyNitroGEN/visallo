...
public class FlightTrackOntology {
    public static final String IRI = "http://visallo.org/flightTrack";
    ...
    public static final StringVisalloProperty AIRPORT_NAME = new StringVisalloProperty("http://visallo.org/flightTrack#airportName");
    public static final StringVisalloProperty AIRLINE_NAME = new StringVisalloProperty("http://visallo.org/flightTrack#airlineName");
}