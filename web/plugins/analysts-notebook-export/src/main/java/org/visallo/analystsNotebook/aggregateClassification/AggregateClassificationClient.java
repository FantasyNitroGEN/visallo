package org.visallo.analystsNotebook.aggregateClassification;
...
public class AggregateClassificationClient {
    private static final VisalloLogger LOGGER = VisalloLoggerFactory.getLogger(AggregateClassificationClient.class);
    ...
    public String getClassificationBanner(Iterable<Vertex> vertices) {
        ...
        try {
            ...
            if (responseCode != HttpURLConnection.HTTP_OK) {
                ...
                throw new VisalloException(responseCode + " (" + responseMessage + ") while accessing: " + aggregateClassificationConfiguration.getServiceUrl());
            }
            ...
            throw new VisalloException("exception while making the aggregate classification request", e);
        }
    }
