...
public class LdapX509AuthenticationHandler extends X509AuthenticationHandler {
    private static final VisalloLogger LOGGER = VisalloLoggerFactory.getLogger(LdapX509AuthenticationHandler.class);
    ...
    protected X509Certificate extractCertificate(HttpServletRequest request) {
        ...
        if (cert != null) {
            ...
            try {
                ...
                throw new VisalloException("failed to extract cert from request header", e);
            }
            if (cert != null) {
