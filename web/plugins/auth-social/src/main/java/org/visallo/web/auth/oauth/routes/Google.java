...
import org.visallo.http.HttpConnection;
    ...
    private void discoverEndpoints() {
        try {
            ...
            if (conn.getResponseCode() != HttpURLConnection.HTTP_OK) {
                throw new VisalloException("Failed to retrieve OpenID Connect discovery document");
            }
            ...
            throw new VisalloException("Error retrieving OpenID Connect discover document", e);
        }
    }
