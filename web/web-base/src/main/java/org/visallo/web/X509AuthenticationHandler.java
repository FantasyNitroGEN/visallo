...
public abstract class X509AuthenticationHandler extends AuthenticationHandler {
    ...
    private static final VisalloLogger LOGGER = VisalloLoggerFactory.getLogger(X509AuthenticationHandler.class);
    ...
    protected String getUsername(X509Certificate cert) {
        ...
        if (dn != null) {
            ...
            throw new VisalloException("failed to get DN from cert for username");
        }
    }
    ...
    protected String getDisplayName(X509Certificate cert) {
        ...
        if (cn != null) {
            ...
            throw new VisalloException("failed to get CN from cert for displayName");
        }
    }
