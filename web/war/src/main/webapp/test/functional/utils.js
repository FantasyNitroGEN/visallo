...
utils = {
    ...
    visalloReady: "$('.login button').length > 0 || ($('.menubar-pane').length > 0 && $('.loading-graph').length === 0)",
    ...
    addMethods: {
        ...
        waitForApplicationLoad: function() {
            ...
            return this.browser
                ...
                .waitFor(this.asserters.jsCondition(utils.visalloReady), utils.pageLoadTimeout)
        },
