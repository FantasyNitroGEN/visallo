    ...
    function AddToWorkspace() {
        ...
        this.done = function(results) {
            ...
            d3.select(select.get(0))
                ...
                .attr('selected', function(workspace) {
                    return visalloData.currentWorkspaceId === workspace.workspaceId ?
                        'selected' : null;
                })
        ...
        this.addToCurrentWorkspace = function() {
            this.trigger('updateWorkspace', {
                ...
                entityUpdates: this.verticesToAdd.map(function(v) {
                    return {
                        vertexId: v.id,
                        graphLayoutJson: {}
                    }
        ...
        this.onAdd = function(event) {
            ...
            if (visalloData.currentWorkspaceId !== workspaceId) {
