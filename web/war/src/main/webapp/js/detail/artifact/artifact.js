    ...
    function Artifact() {
        ...
        this.onDetectedObjectClicked = function(event) {
            ...
            var self = this,
                ...
                property = F.vertex.props(this.attr.data, 'http://visallo.org#detectedObject', propertyKey);
        ...
        this.onDetectedObjectHover = function(event) {
            ...
            this.trigger(
                ...
                F.vertex.props(this.attr.data, 'http://visallo.org#detectedObject', propertyKey)
            );
        };
